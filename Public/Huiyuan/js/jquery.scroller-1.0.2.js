...
(function ($) {
    ...
    function Scroller(elm, dw, settings) {
        ...
        this.pos = function() {
            ...
            w = dw.outerWidth();
            h = dw.outerHeight();
            dw.css({ left: (ww - w) / 2, top: st + (wh - h) / 2 }); //top位置
            dwo.height(0);
        ...
        this.init = function() {
            ...
            if (this.values !== null) {
                ...
                this.temp = this.parseValue('1970-05-15');//初始日期修改edit by baogx 20150504
                this.setValue(false);
            }
        }
    ...
    var methods = {
        init: function (options) {
            ...
            if ($('.dwo').length) {
                ...
                $('body').on('DOMMouseScroll mousewheel', '.dwwl', function (e) {
                    var delta = 0;
                ...
                $('body').on(START_EVENT, '.dwwl', function (e) {
                    if (!move) {
