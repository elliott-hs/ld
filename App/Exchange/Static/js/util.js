var Util = (function () {
	...
	obj.prototype = {
		...
		showmsg: function (msg, funok, funcancel, key,qid,url) {
			//1.
		 ...
		 funok:function() {
			// body...
			var html='';
			$.getJSON('/ldh/exchange.php/Member/doAdd', {
				qid : qid,
				url : url
					...
					if(json.status  == 2 ){
						...
						html+='<div class="pay-fade"><div class="ub ub-ver ub-ac ub-pc pdt2"><img src="/ldh/app/Store/Static/images/images/yes.png" style="width:3em"><div class="c4 pdtb ulev2">支付成功</div></div></div>';
						$("body").append(html);
						setTimeout(function(){
							$(".pay-fade").addClass("hide");
						},2000);
						$("#pay").addClass("hide");
						$("#payok").removeClass("hide");
